...
PalletTownDefaultScript: ; ~$~CHANGED: Don't allow player to enter grass, but don't spawn Oak.~$~
...
PalletTownOakHeyWaitScript: ; ~$~CHANGED: After printing text advising against entering the grass, walk down one step.~$~
;	xor a
...
; PalletTownOakWalksToPlayerScript: ; ~$~REMOVED: None of the next three scripts are needed now. ~$~
	; ld a, PALLETTOWN_OAK
	; ldh [hSpriteIndex], a
...
PalletTownOakText:
	text_far _ThereAreBadThingsOutThereText
	text_end
	; text_asm
