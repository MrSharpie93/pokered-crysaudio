...
; SpriteSheetPointerTable indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_RED                     ; $1f ; ~$~CHANGED: Was unused scientist copy.~$~
	...
	const SPRITE_OFFICER_JENNY           ; $32 ; ~$~CHANGED: Was unused guard copy.~$~
	const SPRITE_MOM                     ; $33
	const SPRITE_BALDING_GUY             ; $34
	const SPRITE_LITTLE_BOY              ; $35
	const SPRITE_GREEN                   ; $36 ; ~$~CHANGED: Was unused Game Boy kid copy.~$~
