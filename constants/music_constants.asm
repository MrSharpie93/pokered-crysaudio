...
; ~$~ADDED: New music.~$~
	const MUSIC_MEET_WEIRD_TRAINER
	const MUSIC_MEET_ROCKET
	const MUSIC_MEET_JESSIE_JAMES
	const MUSIC_MEET_GREEN
	const MUSIC_ROCKET_BATTLE
	const MUSIC_GREEN_BATTLE
	const MUSIC_RED_BATTLE
	const MUSIC_NEW_BARK_TOWN
	const MUSIC_ROUTE_26
	const MUSIC_MT_MOON_SQUARE
	const MUSIC_SEAFOAM_ISLANDS
	const MUSIC_VICTORY_ROAD
	const MUSIC_CERULEAN_CAVE
	const MUSIC_RUINS_INTERIOR
	const MUSIC_GLITCH_CITY
