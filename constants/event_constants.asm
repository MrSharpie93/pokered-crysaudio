...
; Pewter City events
	...
	const EVENT_BEAT_SKELETOPS
	const EVENT_BEAT_OSSIDACTYL
	const_skip 4
...
; Cerulean City events
	...
	const EVENT_GOT_BULBASAUR_IN_CERULEAN ; ~$~ADDED: Starter NPCs from Yellow.~$~
	const_skip 17
...
; Lavender Town events
	...
	const_skip 30 ; ~$~ADDED: Starter NPCs from Yellow.~$~
...
; Fuchsia City events
	...
	const EVENT_MUSEUM_FOSSILS_ACTIVE
	const_skip 19
...
; Route 25 events
	const_next $550 - 1
	const EVENT_GOT_CHARMANDER_FROM_DAMIAN ; ~$~ADDED: Starter NPCs from Yellow.~$~
...
; Silph Co. events ; ~$~Replacing these.~$~
	const_next $6F0
	const_skip 1
	...
	const EVENT_BEAT_ROUTE_26_TRAINER_4
	const EVENT_BEAT_ROUTE_26_TRAINER_5
	const_skip 6
	...
	const_skip 7
	const EVENT_BEAT_ROUTE_27_TRAINER_0
	...
	const EVENT_BEAT_ROUTE_27_TRAINER_5
	const_skip
