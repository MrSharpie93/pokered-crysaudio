...
; "Both" indicates either can be used for different images using the same animation.
	...
	const SUBANIM_3_FIST ; was SUBANIM_0_CIRCLE_1_SQUARE_HALF_TOSS  ; make better
	...
	const SUBANIM_3_BELL ; was SUBANIM_0_CIRCLE_1_SQUARE_APPEARS ; fix for opponent
