...
.nonzeroHP
	...
	ld d, a
	ld c, a
; ~$~CHANGED: Code from shinpokered & KEP for displaying DVs and stat EXP.~$~
...
.DontRecalculate
	...
	call CopyVideoDataDouble ; ─ ┘
;	ld de, PTile ;~$~REMOVED: No longer needed, p for PP handled differently.~$~
...
;PTile: INCBIN "gfx/font/P.1bpp" ;~$~REMOVED: No longer needed, p for PP handled differently.~$~
