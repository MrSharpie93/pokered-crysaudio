...
RedrawPartyMenu__:: ; ~$~CHANGED: New icons. Code from Rangi42 and ShantyTown.~$~
...
.skipUnfilledRightArrow
	...
	cp MOVE_TUTOR_MENU ; ~$~ADDED: Red++'s Move Tutor functionality.~$~
	jr z, .moveTutorMenu
	push hl
	...
	pop hl
	jr .printLevel
.moveTutorMenu ; ~$~ADDED: Red++'s Move Tutor functionality.~$~
	push hl
	call CanLearnTutor
	pop hl
	jr .showAbleNotAble
...
PartyMenuMessagePointers:
	...
	dw PartyMenuItemUseText
	dw PartyMenuUseTMText ; ~$~ADDED: Red++'s Move Tutor functionality.~$~
