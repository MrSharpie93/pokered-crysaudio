; ~$~CHANGED: Implemented better AI using code from PureRGB, with modifications by Kanto Expansion Pak.~$~
...
AIMoveChoiceModificationFunctionPointers:
	...
	dw AIMoveChoiceModification4 ; was unused
...
WillOHKOMoveAlwaysFail: ; ~$~TODO: This should be changed to reflect OHKO moves failing by level, not speed.~$~
	call CompareSpeed
	jr c, .userIsSlower
	and a
	ret
...
;	db ACCURACY_UP1_EFFECT ; ~$~No need to look for these, as no moves use the effects on their own.~$~
...
;	db EVASION_DOWN2_EFFECT
	...
	db HONE_CLAWS_EFFECT
	db DRAGON_DANCE_EFFECT
	db GROWTH_EFFECT
	db COSMIC_POWER_EFFECT
	db -1 ; end
...
;INCLUDE "data/trainers/special_moves.asm" ; ~$~REMOVED: Levels/Moves trainers from RedStar/BlueStar.~$~
...
AIPrintItemUseAndUpdateHPBar:
	...
	ld [wHPBarType], a
	predef UpdateHPBar2
	push af ; ~$~FIXED: HUD updates appropriately.~$~
