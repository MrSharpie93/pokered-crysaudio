...
; Mirror Move even though the only wild Pokémon that knows Transform is Ditto.
	...
	bit TRANSFORMED, [hl]
	jr z, .notTransformed
;	ld a, DITTO ~$~FIXED: Other Pokemon can Transform without becoming Ditto.~$~
...
; ~$~REMOVED: ItemUseCardKey was here. Removed for being utterly useless.~$~
...
.fullyRestorePP
	ld a, [hl] ; move PP
; ~$~FIXED: PP Up and Ethers/Elixers work correctly.~$~
