...
Route20_Object:
	...
	object_event 68, 11, SPRITE_SWIMMER_F, STAY, UP, TEXT_ROUTE20_SWIMMER2, OPP_SWIMMER_F, 15
	object_event 45, 10, SPRITE_SWIMMER_F, STAY, DOWN, TEXT_ROUTE20_SWIMMER3, OPP_SWIMMER_F, 6
	object_event 55, 14, SPRITE_SWIMMER_F, STAY, RIGHT, TEXT_ROUTE20_SWIMMER4, OPP_JR_TRAINER_F, 24
	...
	object_event 24, 12, SPRITE_SWIMMER_F, STAY, DOWN, TEXT_ROUTE20_SWIMMER8, OPP_JR_TRAINER_F, 16
	object_event 15,  8, SPRITE_SWIMMER_F, STAY, UP, TEXT_ROUTE20_SWIMMER9, OPP_SWIMMER_F, 8
