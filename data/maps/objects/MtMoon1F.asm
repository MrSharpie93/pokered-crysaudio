...
MtMoon1F_Object:
	...
	object_event  7, 22, SPRITE_OFFICER_JENNY, STAY, DOWN, TEXT_MTMOON1F_YOUNGSTER2, OPP_OFFICER, 22 ; ~$~CHANGED~$~
	...
	object_event 36, 23, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_ESCAPE_ROPE, ANTIDOTE
	object_event 20, 33, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_POTION2, POTION
	object_event  5, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_TM_WATER_GUN, ETHER
