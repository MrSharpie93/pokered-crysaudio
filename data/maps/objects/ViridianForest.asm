	...
	const_export VIRIDIANFOREST_SAMURAI
...
ViridianForest_Object:
	...
	object_event  2, 41, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_VIRIDIANFOREST_COOLTRAINER_F, OPP_LASS, 23
	object_event 13, 17, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_VIRIDIANFOREST_SAMURAI, OPP_BUG_CATCHER, 12
