	...
	const_export SAFARIZONEEASTRESTHOUSE_STEP_SELLER

SafariZoneEastRestHouse_Object:
	db $17 ; border block

	def_warp_events
	warp_event  4,  7, SAFARI_ZONE_EAST, 5
	warp_event  5,  7, SAFARI_ZONE_EAST, 5

	def_bg_events
	bg_event  3,  0, TEXT_SAFARIZONEEASTRESTHOUSE_DETAILS
	...
	object_event  8,  6, SPRITE_SAFARI_ZONE_WORKER, STAY, LEFT, TEXT_SAFARIZONEEASTRESTHOUSE_STEP_SELLER
