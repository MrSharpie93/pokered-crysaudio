	...
	const_export FUCHSIACITY_MOVE_TUTOR
...
FuchsiaCity_Object:
	...
	bg_event 31, 13, TEXT_FUCHSIACITY_RHYDON_SIGN
	bg_event 13, 15, TEXT_FUCHSIACITY_LAPRAS_SIGN
	bg_event  7,  7, TEXT_FUCHSIACITY_SLOWPOKE_SIGN
	...
	object_event 30, 12, SPRITE_MONSTER, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_RHYDON
	object_event  8, 17, SPRITE_LAPRAS, WALK, ANY_DIR, TEXT_FUCHSIACITY_LAPRAS
	object_event  6,  5, SPRITE_SLOWPOKE, STAY, NONE, TEXT_FUCHSIACITY_SLOWPOKE
	object_event 11,  8, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_FUCHSIACITY_MOVE_TUTOR
