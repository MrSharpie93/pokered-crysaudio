...
FuchsiaGym_Object:
	...
	object_event  8, 13, SPRITE_COOK, STAY, DOWN, TEXT_FUCHSIAGYM_ROCKER1, OPP_JUGGLER, 7
	object_event  7,  8, SPRITE_COOK, STAY, RIGHT, TEXT_FUCHSIAGYM_ROCKER2, OPP_JUGGLER, 3
	object_event  1, 12, SPRITE_COOK, STAY, DOWN, TEXT_FUCHSIAGYM_ROCKER3, OPP_JUGGLER, 8
	...
	object_event  2,  7, SPRITE_COOK, STAY, LEFT, TEXT_FUCHSIAGYM_ROCKER6, OPP_JUGGLER, 4
