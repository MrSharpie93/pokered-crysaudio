...
PokemonMansionB1F_Object:
	...
	def_object_events
	object_event 16, 23, SPRITE_BIKE_SHOP_CLERK, STAY, NONE, TEXT_POKEMONMANSIONB1F_BURGLAR, OPP_BURGLAR, 9
	...
	object_event  5,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_SOLARBEAM, TM_FLAMETHROWER
