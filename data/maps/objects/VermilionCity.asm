	...
	const_export VERMILIONCITY_OFFICERJENNY
	const_export VERMILIONCITY_SUPER_NERD
...
VermilionCity_Object:
	...
	object_event 19, 15, SPRITE_OFFICER_JENNY, STAY, NONE, TEXT_VERMILIONCITY_OFFICERJENNY
	object_event  9, 20, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_VERMILIONCITY_SUPER_NERD
