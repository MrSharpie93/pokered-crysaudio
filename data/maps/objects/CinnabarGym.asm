...
CinnabarGym_Object:
	...
	object_event 17,  8, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, TEXT_CINNABARGYM_SUPER_NERD2, OPP_BURGLAR, 4
	object_event 11,  4, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_CINNABARGYM_SUPER_NERD3, OPP_SUPER_NERD, 10
	object_event 11,  8, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, TEXT_CINNABARGYM_SUPER_NERD4, OPP_BURGLAR, 5
	object_event 11, 14, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_CINNABARGYM_SUPER_NERD5, OPP_SUPER_NERD, 11
	object_event  3, 14, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, TEXT_CINNABARGYM_SUPER_NERD6, OPP_BURGLAR, 6
