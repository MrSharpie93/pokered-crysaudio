...
MapSpriteSets:
	...
	db SPRITESET_INDIGO          ; NEW_BARK_TOWN
	...
	db SPRITESET_INDIGO          ; ROUTE_26
	db SPRITESET_INDIGO          ; ROUTE_27
	db SPRITESET_PEWTER_CERULEAN ; ROUTE_28
	db SPRITESET_PEWTER_CERULEAN ; SILVER_CAVE_OUTSIDE
...
; SPRITESET_PALLET_VIRIDIAN
	...
	db SPRITE_GAMBLER
	db SPRITE_LAPRAS ; ~$~CHANGED: Was Seel.~$~
	db SPRITE_SWIMMER_F ; ~$~CHANGED: Was Oak.~$~
	db SPRITE_SWIMMER
	db SPRITE_POKE_BALL
...
; SPRITESET_PEWTER_CERULEAN
	...
	db SPRITE_MONSTER
	db SPRITE_BLUE
	db SPRITE_OFFICER_JENNY ; ~$~CHANGED: Was guard.~$~
	db SPRITE_COOLTRAINER_F
	db SPRITE_COOLTRAINER_M
	db SPRITE_POKE_BALL
	db SPRITE_SLOWPOKE ; ~$~CHANGED: Was unused drunk.~$~
...
; SPRITESET_VERMILION
	...
	db SPRITE_GAMBLER
	db SPRITE_MONSTER
	db SPRITE_OFFICER_JENNY ; ~$~CHANGED: Yellow starter gift NPC.~$~
	db SPRITE_SAILOR
	db SPRITE_COOLTRAINER_F
	db SPRITE_COOLTRAINER_M
	db SPRITE_POKE_BALL
...
; SPRITESET_CELADON
	...
	db SPRITE_GRAMPS
	db SPRITE_POLIWRATH ; ~$~CHANGED: Was monster.~$~
	db SPRITE_GUARD
	db SPRITE_ROCKET
	db SPRITE_POKE_BALL
	db SPRITE_SUDOWOODO ; ~$~CHANGED: Was Snorlax.~$~

; SPRITESET_INDIGO
	db SPRITE_YOUNGSTER
	db SPRITE_FISHER ; ~$~CHANGED: Was gym guide.~$~
	db SPRITE_MONSTER
	db SPRITE_LAPRAS ; ~$~CHANGED: Was Blue.~$~
	db SPRITE_COOLTRAINER_F
	db SPRITE_COOLTRAINER_M
	db SPRITE_SWIMMER
	db SPRITE_GUARD
...
; SPRITESET_FUCHSIA
	db SPRITE_SWIMMER_F ; ~$~CHANGED: Was bird.~$~
	db SPRITE_COOLTRAINER_M
	db SPRITE_CHANSEY ; ~$~CHANGED: Was Clefairy.~$~
	db SPRITE_FISHER
	db SPRITE_GAMBLER
	db SPRITE_MONSTER
	db SPRITE_LAPRAS ; ~$~CHANGED: Was Seel.~$~
