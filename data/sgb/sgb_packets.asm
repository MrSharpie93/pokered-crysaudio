...
PalPacket_PartyMenu:      PAL_SET PAL_REDTRAINER, PAL_GREENBAR, PAL_YELLOWBAR, PAL_REDBAR
PalPacket_Black:          PAL_SET PAL_BLACK, PAL_BLACK, PAL_BLACK, PAL_BLACK
PalPacket_TownMap:        PAL_SET PAL_TOWNMAP, 0, 0, 0
IF DEF(_RED)
PalPacket_Pokedex:        PAL_SET PAL_REDMON, 0, 0, 0
ENDC
IF DEF(_BLUE)
PalPacket_Pokedex:        PAL_SET PAL_BLUEMON, 0, 0, 0
ENDC
...
PalPacket_GameFreakIntro: PAL_SET PAL_GREENMON, PAL_REDMON, PAL_YELLOWMON, PAL_BLUEMON
PalPacket_DexBalls:       PAL_SET PAL_0F, 0, 0, 0
