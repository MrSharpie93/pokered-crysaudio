...
TextBoxTextAndCoordTable:
	...
	text_box_text USE_INFO_TOSS_MENU_TEMPLATE,       13, 10, 19, 16, UseInfoTossText,         15, 11  ; ~$~CHANGED: Item descriptions.~$~
...
UseInfoTossText: ; ~$~CHANGED: Item descriptions.~$~
	db   "USE"
	next "INFO"
	next "TOSS@"
...
StarterChoiceText: ; ~$~CHANGED: Changing how starter is chosen for story reasons.~$~
	db   "GREEN"
	next "RED"
	next "BLUE@"
